...
$entry = $gdClient->updateCell(16, 4, $_GET['precio'], 
             '0AlkFQsJI6D_7dEZOVXlTeDNYOGsyNVNWalNLdWdDU2c', 3);

		$entry = $gdClient->updateCell(17, 4, $_GET['enganche'], 
		             '0AlkFQsJI6D_7dEZOVXlTeDNYOGsyNVNWalNLdWdDU2c', 3);

				$entry = $gdClient->updateCell(13, 9, $_GET['anio'], 
				             '0AlkFQsJI6D_7dEZOVXlTeDNYOGsyNVNWalNLdWdDU2c', 3);
				
						$entry = $gdClient->updateCell(13, 3, $_GET['marca'], 
						             '0AlkFQsJI6D_7dEZOVXlTeDNYOGsyNVNWalNLdWdDU2c', 3);
						
								$entry = $gdClient->updateCell(14, 3, $_GET['linea'], 
								             '0AlkFQsJI6D_7dEZOVXlTeDNYOGsyNVNWalNLdWdDU2c', 3);
$i = 0;
...
print "<table>
        <tr>
          ...
          ".$interes_fija."
       	...
       	<tr>
          <td>Comision por apertura</td>
          ".$comision."
        </tr>

        <tr>
          <td>Comision por apertura (incluye IVA)</td>
          ".$comision_iva."
        </tr>
